    ...
    feedbacksModel.create(dataStore, function(err, response) {
      ...
      mailer.send({
        ...
        body:
          "Dear " +
          instructorname +
          "<p>Academic - Undergraduate Studies Division has received the following qualitative feedback (Mid-Semester) from your students for your course " +
          courseID +
          " and section " +
          courseSection +
          ...
          feedbackMidsem2 +
          "</p><br><p>You may access all your feedbacks from the Academic - Undergraduate Studies Division Dashboard by visiting the website.</p>"
      });
