! function() {
    ...
    s = function() {
            ...
            if (n.dispatchEvent(l), !l.defaultPrevented) {
                ...
                if (a) s(n, a) || r.push(e(a));
                    ...
                    c.forEach(function(e) {
                        _.contains(e.cssClass) && -1 === r.indexOf(e) && !s(n, e.className) && r.push(e)
                    })
                }
                for (var d, h = 0, u = r.length; h < u; h++) {
                    if (!(d = r[h])) throw new Error("Unable to find a registered component for the given class.");
        ...
        function l(e) {
            ...
            for (var t, s = 0, i = e.length; s < i; s++)(t = e[s]) instanceof HTMLElement && (a(t), t.children.length > 0 && l(t.children))
        }

        function o(t) {
            var s = void 0 === t.widget && void 0 === t.widget,
                i = !0;
    ...
    window.MaterialRadio = c, c.prototype.Constant_ = {
        ...
        for (var t = document.getElementsByClassName(this.CssClasses_.JS_RADIO), s = 0; s < t.length; s++) t[s].querySelector("." + this.CssClasses_.RADIO_BTN).getAttribute("name") === this.btnElement_.getAttribute("name") && void 0 !== t[s].MaterialRadio && t[s].MaterialRadio.updateClasses_()
    ...
    window.MaterialSlider = p, p.prototype.Constant_ = {}, p.prototype.CssClasses_ = {
        ...
        void 0 !== e && (this.element_.value = e), this.updateValueStyles_()
    ...
    window.MaterialRipple = S, S.prototype.Constant_ = {
        ...
        if (this.rippleElement_.classList.add(this.CssClasses_.IS_VISIBLE), "mousedown" === e.type && this.ignoringMouseDown_) this.ignoringMouseDown_ = !1;
            ...
            if ("touchstart" === e.type && (this.ignoringMouseDown_ = !0), this.getFrameCount() > 0) return;
            this.setFrameCount(1);
            var s, i, n = e.currentTarget.getBoundingClientRect();
            if (0 === e.clientX && 0 === e.clientY) s = Math.round(n.width / 2), i = Math.round(n.height / 2);
            else {
                var a = void 0 !== e.clientX ? e.clientX : e.touches[0].clientX,
                    l = void 0 !== e.clientY ? e.clientY : e.touches[0].clientY;
                s = Math.round(a - n.left), i = Math.round(l - n.top)
            }
