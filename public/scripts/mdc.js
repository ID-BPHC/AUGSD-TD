...
! function(t, e) {
    ...
    return function(t) {
        ...
        var c = function() {
            ...
            l = function(t) {
                ...
                return o(e, t), c(e, [{
                    ...
                    set: function(t) {
                        var e = s.a.cssClasses.UNBOUNDED;
                        this.unbounded_ = Boolean(t), this.unbounded_ ? this.root_.classList.add(e) : this.root_.classList.remove(e)
                    }
                }], [{
                    key: "attachTo",
                    value: function(t) {
        ...
        function i(t) {
            ...
            if ("boolean" == typeof u && !e) return u;
            if (t.CSS && "function" == typeof t.CSS.supports) {
                var n = t.CSS.supports("--css-vars", "yes"),
                    i = t.CSS.supports("(--css-vars: yes)") && t.CSS.supports("color", "#00000000");
                return u = !(!n && !i || r(t))
            }
        }
        ...
        function s(t, e, n) {
            var r = e.x,
                ...
                s = void 0,
                u = void 0;
            return "touchstart" === t.type ? (s = t.changedTouches[0].pageX - o, u = t.changedTouches[0].pageY - a) : (s = t.pageX - o, u = t.pageY - a), {
                x: s,
                y: u
            }
        }
        ...
        function r(t) {
            if (!("ontouchstart" in (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : window).document)) switch (t) {
                case "touchstart":
                    return "pointerdown";
                case "touchmove":
                    return "pointermove";
        ...
        function u(t) {
            t.hasAttribute(l) && (t.hasAttribute(c) ? (t.setAttribute("tabindex", t.getAttribute(c)), t.removeAttribute(c)) : t.removeAttribute("tabindex"), t.removeAttribute(l))
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.remapEvent = r, e.getTransformPropertyName = i, e.supportsCssCustomProperties = o, e.applyPassive = a, e.saveElementTabState = s, e.restoreElementTabState = u;
        ...
        var r = n(10),
            i = n(60);
        n.d(e, "MDCSimpleMenu", function() {
            return i.a
        }), n.d(e, "MDCSimpleMenuFoundation", function() {
            return i.b
        }), n.d(e, "util", function() {
            return r
        })
        ...
        function a(t, e, n) {
            ...
            var r = t * e,
                i = e + t * (n - e),
                o = n + t * (1 - n);
            return r += t * (i - r), i += t * (o - i), r + t * (i - r)
        }

        function s(t, e, n) {
            if (t <= 0) return 0;
            if (t >= 1) return 1;
            for (var r = t, i = 0, o = 1, s = 0, u = 0; u < 8; u++) {
                s = a(r, e, n);
                var c = (a(r + 1e-6, e, n) - s) / 1e-6;
                if (Math.abs(s - t) < 1e-6) return r;
                if (Math.abs(c) < 1e-6) break;
                s < t ? i = r : o = r, r -= (s - t) / c
            }
            for (var l = 0; Math.abs(s - t) > 1e-6 && l < 8; l++) s < t ? (i = r, r = (r + o) / 2) : (o = r, r = (r + i) / 2), s = a(r, e, n);
            return r
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var a = n(0),
            ...
            l = function(t) {
                ...
                return o(e, t), c(e, null, [{
                    ...
                    key: "activate",
                    value: function() {
                        this.adapter_.addClass(s.a.BOTTOM_LINE_ACTIVE)
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        this.adapter_.setAttr("style", i)
                    }
                }, {
                    key: "deactivate",
                    value: function() {
                        this.adapter_.removeClass(s.a.BOTTOM_LINE_ACTIVE)
                    }
                }, {
                    key: "handleTransitionEnd",
                    value: function(t) {
                        "opacity" === t.propertyName && this.adapter_.notifyAnimationEnd()
                    }
                }]), e
            }(a.a);
        e.a = l
                ...
                return o(e, t), c(e, null, [{
                    ...
                    value: function(t) {
                        var e = this.adapter_.hasClass(s.a.HELPER_TEXT_PERSISTENT),
                            ...
                            r = n && !t;
                        r ? this.adapter_.setAttr(s.b.ROLE, "alert") : this.adapter_.removeAttr(s.b.ROLE), e || r || this.hide_()
                    }
                }, {
                    key: "hide_",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        return new c.a({
                            ...
                            notifySelected: function() {
                                return t.emit(c.a.strings.SELECTED_EVENT, {
                                    tab: t
                                }, !0)
                            }
                        })
            ...
            l = function(t) {
                ...
                return o(e, t), c(e, [{
                    ...
                    value: function() {
                        ...
                        this.indicator_ = this.root_.querySelector(u.a.strings.INDICATOR_SELECTOR), this.tabs_ = this.gatherTabs_(e), this.tabSelectedHandler_ = function(e) {
                            var n = e.detail,
                                r = n.tab;
                            t.setActiveTab_(r, !0)
                        }
        ...
        n.d(e, "autoInit", function() {
            ...
            return E
        }), r.a.register("MDCCheckbox", o.MDCCheckbox), r.a.register("MDCDialog", a.MDCDialog), r.a.register("MDCPersistentDrawer", s.MDCPersistentDrawer), r.a.register("MDCTemporaryDrawer", s.MDCTemporaryDrawer), r.a.register("MDCFormField", u.MDCFormField), r.a.register("MDCRipple", p.MDCRipple), r.a.register("MDCGridList", c.MDCGridList), r.a.register("MDCIconToggle", l.MDCIconToggle), r.a.register("MDCLinearProgress", d.MDCLinearProgress), r.a.register("MDCRadio", _.MDCRadio), r.a.register("MDCSnackbar", b.MDCSnackbar), r.a.register("MDCTab", g.MDCTab), r.a.register("MDCTabBar", g.MDCTabBar), r.a.register("MDCTextField", m.MDCTextField), r.a.register("MDCSimpleMenu", f.MDCSimpleMenu), r.a.register("MDCSelect", h.MDCSelect), r.a.register("MDCSlider", y.MDCSlider), r.a.register("MDCToolbar", E.MDCToolbar)
    }, function(t, e, n) {
        "use strict";
        ...
        function i() {
            for (var t, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : document, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : a, i = e.querySelectorAll("[data-mdc-auto-init]"), s = 0; t = i[s]; s++) {
                var u = t.dataset.mdcAutoInit;
                if (!u) throw new Error("(mdc-auto-init) Constructor name must be given.");
                var c = o[u];
                if ("function" != typeof c) throw new Error("(mdc-auto-init) Could not find constructor in registry for " + u);
                ...
                return o(e, t), _(e, [{
                    ...
                    value: function() {
                        var t = this,
                            ...
                            n = d(c.MDCRipple.createAdapter(this), {
                                isUnbounded: function() {
                                    return !0
                                },
                                isSurfaceActive: function() {
                                ...
                                computeBoundingRect: function() {
                                    var e = t.root_.getBoundingClientRect(),
                                        n = e.left,
                                        r = e.top;
                                    return {
                                        top: r,
                    ...
                    key: "destroy",
                    value: function() {
                        this.ripple_.destroy(), f(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "destroy", this).call(this)
                    }
                }, {
                    key: "ripple",
                    get: function() {
                ...
                return o(e, t), l(e, null, [{
                    ...
                    value: function() {
                        ...
                        this.listenerInfos_.forEach(function(e) {
                            Object.keys(e).forEach(function(n) {
                                t.adapter_.registerInteractionHandler(e[n], t.listeners_[n])
                            })
                    ...
                    value: function(t) {
                        ...
                        if (!this.adapter_.isSurfaceDisabled()) {
                            ...
                            n.isActivated || (n.isActivated = !0, n.isProgrammatic = null === t, n.activationEvent = t, n.wasActivatedByPointer = !n.isProgrammatic && ("mousedown" === t.type || "touchstart" === t.type || "pointerdown" === t.type), n.activationStartTime = Date.now(), requestAnimationFrame(function() {
                                n.wasElementMadeActive = !t || "keydown" !== t.type || e.adapter_.isSurfaceActive(), n.wasElementMadeActive ? e.animateActivation_() : e.activationState_ = e.defaultActivationState_()
                            }))
                        }
                    }
                }, {
                    ...
                    value: function() {
                        var t = this.activationState_,
                            ...
                            r = void 0;
                        return r = n ? Object(u.getNormalizedEventCoords)(e, this.adapter_.getWindowPageOffset(), this.adapter_.computeBoundingRect()) : {
                    ...
                    value: function(t) {
                        ...
                        if (n.isActivated) {
                            ...
                            var u = c({}, n);
                            requestAnimationFrame(function() {
                                a && (e.activationState_.hasDeactivationUXRun = !0, e.animateDeactivation_(t, u)), s && (e.activationState_ = e.defaultActivationState_())
                            })
                        }
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        this.listenerInfos_.forEach(function(e) {
                            Object.keys(e).forEach(function(n) {
                                t.adapter_.deregisterInteractionHandler(e[n], t.listeners_[n])
                            })
                    ...
                    value: function() {
                        ...
                        this.initialSize_ = t * e.numbers.INITIAL_ORIGIN_SCALE, this.maxRadius_ = n + e.numbers.PADDING, this.fgScale_ = this.maxRadius_ / this.initialSize_, this.xfDuration_ = 1e3 * Math.sqrt(this.maxRadius_ / 1024), this.updateLayoutCssVars_()
                    }
                }, {
        ...
        var s = n(0),
            ...
            f = function(t) {
                function e(t) {
                    r(this, e);
                    var n = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, c(e.defaultAdapter, t)));
                    return n.currentCheckState_ = u.c.TRANSITION_STATE_INIT, n.currentAnimationClass_ = "", n.animEndLatchTimer_ = 0, n.animEndHandler_ = function() {
                ...
                return o(e, t), l(e, null, [{
                    ...
                    key: "init",
                    value: function() {
                        this.currentCheckState_ = this.determineCheckState_(this.getNativeControl_()), this.adapter_.addClass(u.a.UPGRADED), this.adapter_.registerChangeHandler(this.changeHandler_), this.installPropertyChangeHooks_()
                    }
                }, {
                    key: "destroy",
                    value: function() {
                    ...
                    key: "setDisabled",
                    value: function(t) {
                        this.getNativeControl_().disabled = t, t ? this.adapter_.addClass(u.a.DISABLED) : this.adapter_.removeClass(u.a.DISABLED)
                    }
                }, {
                    key: "getValue",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        if (t) {
                            ...
                            e !== n && (this.currentAnimationClass_.length > 0 && (clearTimeout(this.animEndLatchTimer_), this.adapter_.forceLayout(), this.adapter_.removeClass(this.currentAnimationClass_)), this.currentAnimationClass_ = this.getTransitionAnimationClass_(e, n), this.currentCheckState_ = n, this.adapter_.isAttachedToDOM() && this.currentAnimationClass_.length > 0 && (this.adapter_.addClass(this.currentAnimationClass_), this.adapter_.registerAnimationEndHandler(this.animEndHandler_)))
                        }
                    }
                }, {
                    ...
                    value: function(t, n) {
                        var r = u.c.TRANSITION_STATE_INIT,
                            ...
                            _ = a.ANIM_INDETERMINATE_UNCHECKED;
                        switch (t) {
                            case r:
                                if (n === o) return "";
                            case o:
            ...
            f = function(t) {
                ...
                return o(e, t), l(e, [{
                    ...
                    value: function() {
                        ...
                        for (var t, e = this.root_.querySelectorAll(".mdc-dialog__footer__button"), n = 0; t = e[n]; n++) this.footerBtnRipples_.push(new s.MDCRipple(t))
                    }
                }, {
                    key: "destroy",
                    value: function() {
        ...
        var a = n(1),
            ...
            l = function(t) {
                function e(t) {
                    r(this, e);
                    var n = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, u(e.defaultAdapter, t)));
                    return n.isOpen_ = !1, n.componentClickHandler_ = function(t) {
                ...
                return o(e, t), c(e, null, [{
                    ...
                    key: "destroy",
                    value: function() {
                        this.isOpen_ && (this.adapter_.deregisterSurfaceInteractionHandler("click", this.dialogClickHandler_), this.adapter_.deregisterDocumentKeydownHandler(this.documentKeydownHandler_), this.adapter_.deregisterInteractionHandler("click", this.componentClickHandler_), this.adapter_.untrapFocusOnSurface(), this.adapter_.deregisterTransitionEndHandler(this.transitionEndHandler_), this.adapter_.removeClass(e.cssClasses.ANIMATING), this.adapter_.removeClass(e.cssClasses.OPEN), this.enableScroll_())
                    }
                }, {
                    key: "open",
                    value: function() {
                        this.isOpen_ = !0, this.disableScroll_(), this.adapter_.registerDocumentKeydownHandler(this.documentKeydownHandler_), this.adapter_.registerSurfaceInteractionHandler("click", this.dialogClickHandler_), this.adapter_.registerInteractionHandler("click", this.componentClickHandler_), this.adapter_.registerTransitionEndHandler(this.transitionEndHandler_), this.adapter_.addClass(e.cssClasses.ANIMATING), this.adapter_.addClass(e.cssClasses.OPEN)
                    }
                }, {
                    key: "close",
                    value: function() {
                        this.isOpen_ = !1, this.adapter_.deregisterSurfaceInteractionHandler("click", this.dialogClickHandler_), this.adapter_.deregisterDocumentKeydownHandler(this.documentKeydownHandler_), this.adapter_.deregisterInteractionHandler("click", this.componentClickHandler_), this.adapter_.untrapFocusOnSurface(), this.adapter_.registerTransitionEndHandler(this.transitionEndHandler_), this.adapter_.addClass(e.cssClasses.ANIMATING), this.adapter_.removeClass(e.cssClasses.OPEN)
                    }
                }, {
                    key: "isOpen",
                    value: function() {
                    ...
                    value: function(t) {
                        var e = t.target;
                        this.adapter_.eventTargetHasClass(e, s.a.ACCEPT_BTN) ? this.accept(!0) : this.adapter_.eventTargetHasClass(e, s.a.CANCEL_BTN) && this.cancel(!0)
                    }
                }, {
                    key: "handleTransitionEnd_",
                    value: function(t) {
                        this.adapter_.isDialog(t.target) && (this.adapter_.deregisterTransitionEndHandler(this.transitionEndHandler_), this.adapter_.removeClass(e.cssClasses.ANIMATING), this.isOpen_ ? (this.adapter_.trapFocusOnSurface(), this.adapter_.layoutFooterRipples()) : this.enableScroll_())
                    }
                }, {
                    key: "disableScroll_",
                    value: function() {
        ...
        function r(t, e) {
            function n(t) {
                if (!C) {
                    var e = {
                        onActivate: t && void 0 !== t.onActivate ? t.onActivate : k.onActivate
                    };
                    return C = !0, T = !1, E = document.activeElement, e.onActivate && e.onActivate(), l(), A
                }
            }
            ...
            function r(t) {
                if (C) {
                    ...
                    return d(), e.onDeactivate && e.onDeactivate(), e.returnFocus && setTimeout(function() {
                        o(E)
                    }, 0), C = !1, T = !1, this
                }
            }
            ...
            function l() {
                if (C) return s && s.pause(), s = A, g(), o(_()), document.addEventListener("focus", v, !0), document.addEventListener("click", h, !0), document.addEventListener("mousedown", p, !0), document.addEventListener("touchstart", p, !0), document.addEventListener("keydown", y, !0), A
            }

            function d() {
                if (C && s === A) return document.removeEventListener("focus", v, !0), document.removeEventListener("click", h, !0), document.removeEventListener("mousedown", p, !0), document.removeEventListener("touchstart", p, !0), document.removeEventListener("keydown", y, !0), s = null, A
            }
            ...
            function _() {
                var t;
                if (!(t = null !== f("initialFocus") ? f("initialFocus") : O.contains(document.activeElement) ? document.activeElement : m[0] || f("fallbackFocus"))) throw new Error("You can't have a focus-trap without at least one focusable element");
                return t
            }

            function p(t) {
                k.clickOutsideDeactivates && !O.contains(t.target) && r({
                    returnFocus: !1
                })
            }

            function h(t) {
                k.clickOutsideDeactivates || O.contains(t.target) || (t.preventDefault(), t.stopImmediatePropagation())
            }

            function v(t) {
                O.contains(t.target) || (t.preventDefault(), t.stopImmediatePropagation(), "function" == typeof t.target.blur && t.target.blur())
            }
            ...
            function b(t) {
                ...
                var e = m.indexOf(t.target),
                    n = m[m.length - 1],
                    r = m[0];
                return t.shiftKey ? o(t.target === r || -1 === m.indexOf(t.target) ? n : m[e - 1]) : t.target === n ? o(r) : void o(m[e + 1])
            }
            ...
            var m = [],
                ...
                k = e || {};
            k.returnFocusOnDeactivate = !e || void 0 === e.returnFocusOnDeactivate || e.returnFocusOnDeactivate, k.escapeDeactivates = !e || void 0 === e.escapeDeactivates || e.escapeDeactivates;
            var A = {
                activate: n,
                deactivate: r,
                pause: u,
        ...
        t.exports = function(t) {
            for (var e, r, i = [], o = [], a = n(), s = ["input", "select", "a[href]", "textarea", "button", "[tabindex]"], u = t.querySelectorAll(s), c = 0, l = u.length; c < l; c++) e = u[c], (r = parseInt(e.getAttribute("tabindex"), 10) || e.tabIndex) < 0 || "INPUT" === e.tagName && "hidden" === e.type || e.disabled || a(e) || (0 === r ? i.push(e) : o.push({
                tabIndex: r,
                node: e
            }));
            var d = o.sort(function(t, e) {
                return t.tabIndex - e.tabIndex
            }).map(function(t) {
                return t.node
            });
            return Array.prototype.push.apply(d, i), d
        }
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
                    ...
                    value: function() {
                        ...
                        return new s.a({
                            ...
                            setTranslateX: function(e) {
                                return t.drawer.style.setProperty(u.getTransformPropertyName(), null === e ? null : "translateX(" + e + "px)")
                            },
        ...
        var a = n(7),
            ...
            d = function(t) {
                function e(t) {
                    r(this, e);
                    var n = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, u(e.defaultAdapter, t), e.cssClasses.ROOT, e.cssClasses.ANIMATING, e.cssClasses.OPEN));
                    return n.componentClickHandler_ = function(t) {
                ...
                return o(e, t), l(e, null, [{
                    ...
                    key: "init",
                    value: function() {
                        c(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "init", this).call(this), this.adapter_.updateCssVariable(0), this.adapter_.registerInteractionHandler("click", this.componentClickHandler_)
                    }
                }, {
                    key: "destroy",
                    value: function() {
                        c(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "destroy", this).call(this), this.adapter_.deregisterInteractionHandler("click", this.componentClickHandler_), this.enableScroll_()
                    }
                }, {
                    key: "open",
                    value: function() {
                        this.disableScroll_(), this.adapter_.updateCssVariable(""), c(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "open", this).call(this)
                    }
                }, {
                    key: "close",
                    value: function() {
                        this.adapter_.updateCssVariable(""), c(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "close", this).call(this)
                    }
                }, {
                    key: "prepareForTouchEnd_",
                    value: function() {
                        c(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "prepareForTouchEnd_", this).call(this), this.adapter_.updateCssVariable("")
                    }
                }, {
                    key: "updateDrawer_",
                    value: function() {
                    ...
                    key: "handleTransitionEnd_",
                    value: function(t) {
                        c(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "handleTransitionEnd_", this).call(this, t), this.isOpen_ || this.enableScroll_()
                    }
                }, {
                    key: "disableScroll_",
                    value: function() {
        ...
        var a = n(1),
            ...
            c = function(t) {
                function e(t, n, o, a) {
                    ...
                    return u.rootCssClass_ = n, u.animatingCssClass_ = o, u.openCssClass_ = a, u.transitionEndHandler_ = function(t) {
                        return u.handleTransitionEnd_(t)
                    }, u.inert_ = !1, u.componentTouchStartHandler_ = function(t) {
                ...
                return o(e, t), u(e, null, [{
                    ...
                    value: function() {
                        ...
                        if (!this.adapter_.hasNecessaryDom()) throw new Error("Required DOM nodes missing in " + t + " component.");
                    ...
                    value: function(t) {
                        this.adapter_.hasClass(this.openCssClass_) && (t.pointerType && "touch" !== t.pointerType || (this.direction_ = this.adapter_.isRtl() ? -1 : 1, this.drawerWidth_ = this.adapter_.getDrawerWidth(), this.startX_ = t.touches ? t.touches[0].pageX : t.pageX, this.currentX_ = this.startX_, this.updateRaf_ = requestAnimationFrame(this.updateDrawer_.bind(this))))
                    }
                }, {
                    key: "handleTouchMove_",
                    value: function(t) {
                        t.pointerType && "touch" !== t.pointerType || (this.currentX_ = t.touches ? t.touches[0].pageX : t.pageX)
                    }
                }, {
                    key: "handleTouchEnd_",
                    value: function(t) {
                        t.pointerType && "touch" !== t.pointerType || (this.prepareForTouchEnd_(), Math.abs(this.newPosition_ / this.drawerWidth_) >= .5 ? this.close() : this.open())
                    }
                }, {
                    key: "prepareForTouchEnd_",
                    value: function() {
                    ...
                    key: "updateDrawer_",
                    value: function() {
                        this.updateRaf_ = requestAnimationFrame(this.updateDrawer_.bind(this)), this.adapter_.setTranslateX(this.newPosition_)
                    }
                }, {
                    key: "isRootTransitioningEventTarget_",
                    value: function() {
                    ...
                    key: "handleTransitionEnd_",
                    value: function(t) {
                        this.isRootTransitioningEventTarget_(t.target) && (this.adapter_.removeClass(this.animatingCssClass_), this.adapter_.deregisterTransitionEndHandler(this.transitionEndHandler_))
                    }
                }, {
                    key: "newPosition_",
                    get: function() {
        ...
        var a = n(7),
            ...
            l = function(t) {
                function e(t) {
                    return r(this, e), i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, u(e.defaultAdapter, t), e.cssClasses.ROOT, e.cssClasses.ANIMATING, e.cssClasses.OPEN))
                }
                return o(e, t), c(e, null, [{
                    key: "cssClasses",
                    get: function() {
        ...
        var a = n(2),
            s = n(47);
        n(4), n.d(e, "MDCFormFieldFoundation", function() {
            return s.a
        });
        var u = function() {
                function t(t, e) {
        ...
        var c = Object.assign || function(t) {
            ...
            f = function(t) {
                ...
                return o(e, t), d(e, null, [{
                    ...
                    key: "initialSyncWithDOM",
                    value: function() {
                        this.on = "true" === this.root_.getAttribute(s.a.strings.ARIA_PRESSED), this.disabled = "true" === this.root_.getAttribute(s.a.strings.ARIA_DISABLED)
                    }
                }, {
        ...
        f.prototype.label, f.prototype.content, f.prototype.cssClass, e.a = d
    }, function(t, e, n) {
        "use strict";
        ...
        var a = n(1),
            ...
            d = function(t) {
                ...
                return o(e, t), l(e, null, [{
                    ...
                    key: "init",
                    value: function() {
                        this.determinate_ = !this.adapter_.hasClass(u.a.INDETERMINATE_CLASS), this.reverse_ = this.adapter_.hasClass(u.a.REVERSED_CLASS)
                    }
                }, {
                    key: "setDeterminate",
                    value: function(t) {
                        this.determinate_ = t, this.determinate_ ? this.adapter_.removeClass(u.a.INDETERMINATE_CLASS) : (this.adapter_.addClass(u.a.INDETERMINATE_CLASS), this.setScale_(this.adapter_.getPrimaryBar(), 1), this.setScale_(this.adapter_.getBuffer(), 1))
                    }
                }, {
                    key: "setProgress",
                    value: function(t) {
                    ...
                    key: "setReverse",
                    value: function(t) {
                        this.reverse_ = t, this.reverse_ ? this.adapter_.addClass(u.a.REVERSED_CLASS) : this.adapter_.removeClass(u.a.REVERSED_CLASS)
                    }
                }, {
                    key: "open",
                    value: function() {
                ...
                return o(e, t), c(e, [{
                    ...
                    value: function() {
                        ...
                        return new s.a({
                            ...
                            setScale: function(e, n) {
                                t.root_.style[Object(u.getTransformPropertyName)(window)] = "scale(" + e + ", " + n + ")"
                            },
                            setInnerScale: function(e, n) {
                                t.itemsContainer_.style[Object(u.getTransformPropertyName)(window)] = "scale(" + e + ", " + n + ")"
                            },
                            ...
                            getYParamsForItemAtIndex: function(e) {
                                var n = t.items[e];
                                return {
                                    top: n.offsetTop,
                            ...
                            setTransitionDelayForItemAtIndex: function(e, n) {
                                return t.items[e].style.setProperty("transition-delay", n)
                            },
                            getIndexForEventTarget: function(e) {
                                return t.items.indexOf(e)
                            },
                            notifySelected: function(e) {
                                return t.emit(s.a.strings.SELECTED_EVENT, {
                                    index: e.index,
                                    item: t.items[e.index]
                                })
                            },
                            notifyCancel: function() {
                                return t.emit(s.a.strings.CANCEL_EVENT, {})
                            },
                            saveFocus: function() {
                            ...
                            setTransformOrigin: function(e) {
                                t.root_.style[Object(u.getTransformPropertyName)(window) + "-origin"] = e
                            },
        ...
        var s = n(0),
            ...
            f = function(t) {
                function e(t) {
                    ...
                    }, n.isOpen_ = !1, n.startScaleX_ = 0, n.startScaleY_ = 0, n.targetScale_ = 1, n.scaleX_ = 0, n.scaleY_ = 0, n.running_ = !1, n.selectedTriggerTimerId_ = 0, n.animationRequestId_ = 0, n.dimensions_, n.startTime_, n.itemHeight_, n
                }
                return a(e, t), d(e, null, [{
                    key: "cssClasses",
                    get: function() {
                        return u.a
                    }
                    ...
                    value: function() {
                        for (var t = e.cssClasses, n = t.BOTTOM_LEFT, r = t.BOTTOM_RIGHT, i = this.adapter_.getNumberOfItems(), o = this.dimensions_.height, a = e.numbers.TRANSITION_DURATION_MS / 1e3, s = e.numbers.TRANSITION_SCALE_ADJUSTMENT_Y, u = 0; u < i; u++) {
                            var c = this.adapter_.getYParamsForItemAtIndex(u),
                                l = c.top,
                                d = c.height;
                            this.itemHeight_ = d;
                            var f = l / o;
                            ...
                            var _ = (s + f * (1 - s)) * a;
                            this.adapter_.setTransitionDelayForItemAtIndex(u, _.toFixed(3) + "s")
                        }
                    }
                }, {
                    key: "removeTransitionDelays_",
                    value: function() {
                        for (var t = this.adapter_.getNumberOfItems(), e = 0; e < t; e++) this.adapter_.setTransitionDelayForItemAtIndex(e, null)
                    }
                }, {
                    key: "animationLoop_",
                    value: function() {
                        var t = this,
                            ...
                            p = f,
                            h = this.startScaleY_;
                        1 === this.targetScale_ && (this.itemHeight_ && (h = Math.max(this.itemHeight_ / this.dimensions_.height, h)), _ = Object(c.clamp)(f + l), p = Object(c.clamp)((f - d) / (1 - d)));
                        var v = Object(c.bezierProgress)(_, o, a, s, u),
                        ...
                        this.scaleY_ = h + (this.targetScale_ - h) * y;
                        var g = 1 / (0 === this.scaleY_ ? 1 : this.scaleY_);
                        this.adapter_.setScale(this.scaleX_, this.scaleY_), this.adapter_.setInnerScale(b, g), f < 1 ? this.animationRequestId_ = requestAnimationFrame(function() {
                            return t.animationLoop_()
                        }) : (this.animationRequestId_ = 0, this.running_ = !1, this.adapter_.removeClass(e.cssClasses.ANIMATING))
                    }
                }, {
                    key: "animateMenu_",
                    value: function() {
                    ...
                    key: "focusOnOpen_",
                    value: function(t) {
                        null === t ? (this.adapter_.focus(), this.adapter_.isFocused() || this.adapter_.focusItemAtIndex(0)) : this.adapter_.focusItemAtIndex(t)
                    }
                }, {
                    key: "handleDocumentClick_",
                    value: function(t) {
                        for (var e = t.target; e && e !== document.documentElement;) {
                            if (this.adapter_.eventTargetHasClass(e, u.a.LIST_ITEM)) return;
                            e = e.parentNode
                        }
                    ...
                    value: function(t) {
                        ...
                        return r && i && 0 === u ? (this.adapter_.focusItemAtIndex(c), t.preventDefault(), !1) : !r && i && u === c ? (this.adapter_.focusItemAtIndex(0), t.preventDefault(), !1) : ((o || a || s) && t.preventDefault(), o ? 0 === u || this.adapter_.isFocused() ? this.adapter_.focusItemAtIndex(c) : this.adapter_.focusItemAtIndex(u - 1) : a && (u === c || this.adapter_.isFocused() ? this.adapter_.focusItemAtIndex(0) : this.adapter_.focusItemAtIndex(u + 1)), !0)
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        var e = t.keyCode,
                            ...
                            i = "Space" === n || 32 === e,
                            o = "Escape" === n || 27 === e;
                        return (r || i) && this.handlePossibleSelected_(t), o && (this.adapter_.notifyCancel(), this.close()), !0
                    }
                }, {
                    key: "handlePossibleSelected_",
                    value: function(t) {
                        var e = this;
                        if ("true" !== this.adapter_.getAttributeForEventTarget(t.target, u.c.ARIA_DISABLED_ATTR)) {
                            ...
                            n < 0 || this.selectedTriggerTimerId_ || (this.selectedTriggerTimerId_ = setTimeout(function() {
                                e.selectedTriggerTimerId_ = 0, e.close(), e.adapter_.notifySelected({
                                    index: n
                                })
                            }, u.b.SELECTED_TRIGGER_DELAY))
                        }
                    }
                }, {
                    key: "autoPosition_",
                    value: function() {
                        ...
                        if (this.adapter_.hasAnchor()) {
                            ...
                            a > 0 && s < a && (e = "bottom");
                            var u = i.left + this.dimensions_.width - o.width,
                                c = this.dimensions_.width - i.right,
                                l = u > 0,
                                d = c > 0;
                            this.adapter_.isRtl() ? (n = "right", d && u < c && (n = "left")) : l && c < u && (n = "right");
                            var f = (t = {}, r(t, n, "0"), r(t, e, "0"), t);
                            this.adapter_.setTransformOrigin(e + " " + n), this.adapter_.setPosition(f)
                        }
                    }
                }, {
                    key: "open",
                    value: function() {
                        var t = this,
                            ...
                            r = n.focusIndex,
                            i = void 0 === r ? null : r;
                        this.adapter_.saveFocus(), this.adapter_.addClass(e.cssClasses.ANIMATING), this.animationRequestId_ = requestAnimationFrame(function() {
                            t.dimensions_ = t.adapter_.getInnerDimensions(), t.applyTransitionDelays_(), t.autoPosition_(), t.animateMenu_(), t.adapter_.addClass(e.cssClasses.OPEN), t.focusOnOpen_(i), t.adapter_.registerBodyClickHandler(t.documentClickHandler_)
                        }), this.isOpen_ = !0
                    }
                }, {
                    key: "close",
                    value: function() {
                        ...
                        !!n && "true" === this.adapter_.getAttributeForEventTarget(n.target, u.c.ARIA_DISABLED_ATTR) || (this.adapter_.deregisterBodyClickHandler(this.documentClickHandler_), this.adapter_.addClass(e.cssClasses.ANIMATING), requestAnimationFrame(function() {
                            t.removeTransitionDelays_(), t.animateMenu_(), t.adapter_.removeClass(e.cssClasses.OPEN)
        ...
        var a = n(0),
            ...
            c = function(t) {
                ...
                return o(e, t), u(e, [{
                    ...
                    value: function(t) {
                        var n = e.cssClasses.DISABLED;
                        this.getNativeControl_().disabled = t, t ? this.adapter_.addClass(n) : this.adapter_.removeClass(n)
                    }
                }, {
                    key: "getValue",
                    value: function() {
        ...
        var d = function() {
            ...
            f = function(t) {
                ...
                return o(e, t), d(e, [{
                    ...
                    key: "nameditem",
                    value: function(t) {
                        for (var e, n = 0, r = this.options; e = r[n]; n++)
                    ...
                    value: function() {
                        ...
                        return new c.a({
                            ...
                            addClassToLabel: function(e) {
                                return t.label_.classList.add(e)
                            },
                            removeClassFromLabel: function(e) {
                                return t.label_.classList.remove(e)
                            },
                            addClassToBottomLine: function(e) {
                                return t.bottomLine_.classList.add(e)
                            },
                            removeClassFromBottomLine: function(e) {
                                return t.bottomLine_.classList.remove(e)
                            },
                            setBottomLineAttr: function(e, n) {
                                return t.bottomLine_.setAttribute(e, n)
                            },
                            setAttr: function(e, n) {
                                return t.root_.setAttribute(e, n)
                            },
                            rmAttr: function(e, n) {
                                return t.root_.removeAttribute(e, n)
                            },
                            computeBoundingRect: function() {
                                return t.surface_.getBoundingClientRect()
                            },
                            registerInteractionHandler: function(e, n) {
                                return t.root_.addEventListener(e, n)
                            },
                            ...
                            getComputedStyleValue: function(e) {
                                return window.getComputedStyle(t.surface_).getPropertyValue(e)
                            },
                            setStyle: function(e, n) {
                                return t.surface_.style.setProperty(e, n)
                            },
                            create2dRenderingContext: function() {
                                return document.createElement("canvas").getContext("2d")
                            },
                            setMenuElStyle: function(e, n) {
                                return t.menuEl_.style.setProperty(e, n)
                            },
                            setMenuElAttr: function(e, n) {
                                return t.menuEl_.setAttribute(e, n)
                            },
                            rmMenuElAttr: function(e) {
                                return t.menuEl_.removeAttribute(e)
                            },
                            getMenuElOffsetHeight: function() {
                                return t.menuEl_.offsetHeight
                            },
                            openMenu: function(e) {
                                return t.menu_.show({
                                    focusIndex: e
                            ...
                            setSelectedTextContent: function(e) {
                                t.selectedText_.textContent = e
                            },
                            getNumberOfOptions: function() {
                                return t.options.length
                            },
                            getTextForOptionAtIndex: function(e) {
                                return t.options[e].textContent
                            },
                            getValueForOptionAtIndex: function(e) {
                                return t.options[e].id || t.options[e].textContent
                            },
                            setAttrForOptionAtIndex: function(e, n, r) {
                                return t.options[e].setAttribute(n, r)
                            },
                            rmAttrForOptionAtIndex: function(e, n) {
                                return t.options[e].removeAttribute(n)
                            },
                            getOffsetTopForOptionAtIndex: function(e) {
                                return t.options[e].offsetTop
                            },
                            registerMenuInteractionHandler: function(e, n) {
                                return t.menu_.listen(e, n)
                            },
                            deregisterMenuInteractionHandler: function(e, n) {
                                return t.menu_.unlisten(e, n)
                            },
                            notifyChange: function() {
                                return t.emit(c.a.strings.CHANGE_EVENT, t)
                            },
        ...
        var a = n(1),
            ...
            f = function(t) {
                function e(t) {
                    r(this, e);
                    var n = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, c(e.defaultAdapter, t)));
                    return n.ctx_ = null, n.selectedIndex_ = -1, n.disabled_ = !1, n.isFocused_ = !1, n.setPointerXOffset_ = function(t) {
                        return n.setBottomLineOrigin_(t)
                    }, n.displayHandler_ = function(t) {
                        t.preventDefault(), n.adapter_.isMenuOpen() || n.open_()
                    }, n.displayViaKeyboardHandler_ = function(t) {
                        return n.handleDisplayViaKeyboard_(t)
                    }, n.selectionHandler_ = function(t) {
                        var e = t.detail,
                            r = e.index;
                        r !== n.selectedIndex_ && (n.setSelectedIndex(r), n.adapter_.notifyChange()), n.close_()
                    }, n.cancelHandler_ = function() {
                        n.close_(), -1 === n.selectedIndex_ && n.adapter_.removeClassFromLabel(s.a.LABEL_FLOAT_ABOVE)
                    }, n
                }
                return o(e, t), l(e, null, [{
                    key: "cssClasses",
                    ...
                    value: function() {
                        ...
                        this.ctx_ = this.adapter_.create2dRenderingContext(), this.adapter_.registerInteractionHandler("click", this.displayHandler_), this.adapter_.registerInteractionHandler("keydown", this.displayViaKeyboardHandler_), this.adapter_.registerInteractionHandler("keyup", this.displayViaKeyboardHandler_), this.adapter_.registerMenuInteractionHandler(u.MDCSimpleMenuFoundation.strings.SELECTED_EVENT, this.selectionHandler_), this.adapter_.registerMenuInteractionHandler(u.MDCSimpleMenuFoundation.strings.CANCEL_EVENT, this.cancelHandler_), ["mousedown", "touchstart"].forEach(function(e) {
                            t.adapter_.registerInteractionHandler(e, t.setPointerXOffset_)
                        }), this.resize()
                    }
                }, {
                    key: "destroy",
                    value: function() {
                        ...
                        this.ctx_ = null, this.adapter_.deregisterInteractionHandler("click", this.displayHandler_), this.adapter_.deregisterInteractionHandler("keydown", this.displayViaKeyboardHandler_), this.adapter_.deregisterInteractionHandler("keyup", this.displayViaKeyboardHandler_), this.adapter_.deregisterMenuInteractionHandler(u.MDCSimpleMenuFoundation.strings.SELECTED_EVENT, this.selectionHandler_), this.adapter_.deregisterMenuInteractionHandler(u.MDCSimpleMenuFoundation.strings.CANCEL_EVENT, this.cancelHandler_), ["mousedown", "touchstart"].forEach(function(e) {
                            t.adapter_.deregisterInteractionHandler(e, t.setPointerXOffset_)
                        })
                    }
                }, {
                    key: "getValue",
                    ...
                    value: function(t) {
                        this.selectedIndex_ >= 0 && this.adapter_.rmAttrForOptionAtIndex(this.selectedIndex_, "aria-selected"), this.selectedIndex_ = t >= 0 && t < this.adapter_.getNumberOfOptions() ? t : -1;
                        var e = "";
                        this.selectedIndex_ >= 0 && (e = this.adapter_.getTextForOptionAtIndex(this.selectedIndex_).trim(), this.adapter_.setAttrForOptionAtIndex(this.selectedIndex_, "aria-selected", "true")), this.adapter_.setSelectedTextContent(e)
                    }
                }, {
                    key: "isDisabled",
                    value: function() {
                    ...
                    value: function(t) {
                        var n = e.cssClasses.DISABLED;
                        this.disabled_ = t, this.disabled_ ? (this.adapter_.addClass(n), this.adapter_.setAttr("aria-disabled", "true"), this.adapter_.makeUntabbable()) : (this.adapter_.removeClass(n), this.adapter_.rmAttr("aria-disabled"), this.adapter_.makeTabbable())
                    }
                }, {
                    key: "resize",
                    value: function() {
                        var t = this.adapter_.getComputedStyleValue("font"),
                        ...
                        for (var i = 0, o = 0, a = this.adapter_.getNumberOfOptions(); o < a; o++) {
                            var s = parseInt(this.adapter_.getComputedStyleValue("padding-right"), 10),
                    ...
                    value: function() {
                        this.disableScroll_();
                        var t = e.cssClasses.OPEN,
                            n = this.selectedIndex_ < 0 ? 0 : this.selectedIndex_;
                        this.setMenuStylesForOpenAtIndex_(n), this.adapter_.addClassToLabel(s.a.LABEL_FLOAT_ABOVE), this.adapter_.addClassToBottomLine(s.a.BOTTOM_LINE_ACTIVE), this.adapter_.addClass(t), this.adapter_.openMenu(n), this.isFocused_ = !0
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        this.adapter_.setBottomLineAttr("style", i)
                    }
                }, {
                    key: "setMenuStylesForOpenAtIndex_",
                    value: function(t) {
                        var e = this.adapter_.getWindowInnerHeight(),
                        ...
                        var s = i - a,
                            u = s < 0,
                            c = s + o > e;
                        u ? s = 0 : c && (s = Math.max(0, e - o)), this.adapter_.setMenuElStyle("left", r + "px"), this.adapter_.setMenuElStyle("top", s + "px"), this.adapter_.setMenuElStyle("transform-origin", "center " + a + "px")
                    }
                }, {
                    key: "close_",
                    value: function() {
                        var t = e.cssClasses.OPEN;
                        this.adapter_.removeClass(t), this.adapter_.removeClassFromBottomLine(s.a.BOTTOM_LINE_ACTIVE), this.adapter_.focus(), this.enableScroll_()
                    }
                }, {
                    key: "handleDisplayViaKeyboard_",
                    value: function(t) {
                        2 === t.eventPhase && ("keydown" === t.type && ("Space" === t.key || 32 === t.keyCode) && t.preventDefault(), d.some(function(e) {
                            var n = e.key,
                                r = e.keyCode,
                                i = e.forType;
                            return t.type === i && (t.key === n || t.keyCode === r)
        ...
        var c = function() {
            ...
            l = function(t) {
                ...
                return o(e, t), c(e, [{
                    key: "initialize",
                    value: function() {
                        this.thumbContainer_ = this.root_.querySelector(s.c.THUMB_CONTAINER_SELECTOR), this.track_ = this.root_.querySelector(s.c.TRACK_SELECTOR), this.pinValueMarker_ = this.root_.querySelector(s.c.PIN_VALUE_MARKER_SELECTOR), this.trackMarkerContainer_ = this.root_.querySelector(s.c.TRACK_MARKER_CONTAINER_SELECTOR)
                    }
                }, {
                    key: "getDefaultFoundation",
                    value: function() {
        ...
        var a = n(15),
            ...
            _ = function(t) {
                function e() {
                    ...
                    }, n.mousedownHandler_ = n.createDownHandler_("mousemove"), n.pointerdownHandler_ = n.createDownHandler_("pointermove"), n.touchstartHandler_ = n.createDownHandler_("touchmove", function(t) {
                        return t.targetTouches[0].pageX
                    }), n.keydownHandler_ = function(t) {
                ...
                return o(e, t), l(e, null, [{
                    ...
                    value: function() {
                        if (this.isDiscrete_ && this.hasTrackMarker_ && 0 != this.getStep()) {
                            ...
                            if (i && (r = Math.ceil(r)), this.adapter_.removeTrackMarkers(), this.adapter_.appendTrackMarkers(r), i) {
                                ...
                                this.adapter_.setLastTrackMarkersStyleProperty(a, o)
                            }
                        }
                    }
                }, {
                    ...
                    value: function(t) {
                        var e = this,
                            n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : function(t) {
                                return t.pageX
                            },
                            r = function(t) {
                                t.preventDefault(), e.setValueFromEvt_(t, n)
                            },
                            i = function n() {
                                e.setActive_(!1), e.adapter_.deregisterBodyInteractionHandler(t, r), f.forEach(function(t) {
                                    return e.adapter_.deregisterBodyInteractionHandler(t, n)
                                }), e.adapter_.notifyChange()
                            };
                        return function(o) {
                            e.disabled_ || (e.preventFocusState_ = !0, e.setInTransit_(!e.handlingThumbTargetEvt_), e.handlingThumbTargetEvt_ = !1, e.setActive_(!0), e.adapter_.registerBodyInteractionHandler(t, r), f.forEach(function(t) {
                                return e.adapter_.registerBodyInteractionHandler(t, i)
                            }), e.setValueFromEvt_(o, n))
                        }
                    }
                }, {
                    ...
                    value: function(t) {
                        var e = this.max_,
                            ...
                            r = this.step_,
                            i = r || (e - n) / 100;
                        switch (this.adapter_.isRTL() && (t === d.ARROW_LEFT || t === d.ARROW_RIGHT) && (i = -i), t) {
                            case d.ARROW_LEFT:
                            case d.ARROW_DOWN:
            ...
            l = function(t) {
                function e(t) {
                    ...
                    return n.active_ = !1, n.actionWasClicked_ = !1, n.dismissOnAction_ = !0, n.firstFocus_ = !0, n.pointerDownRecognized_ = !1, n.snackbarHasFocus_ = !1, n.snackbarData_ = null, n.queue_ = [], n.actionClickHandler_ = function() {
                        ...
                        clearTimeout(n.timeoutId_), n.snackbarHasFocus_ = !0, n.adapter_.visibilityIsHidden() || setTimeout(n.cleanup_.bind(n), n.snackbarData_.timeout || s.b.MESSAGE_TIMEOUT)
                    }, n.interactionHandler_ = function(t) {
                        "touchstart" != t.type && "mousedown" != t.type || (n.pointerDownRecognized_ = !0), n.handlePossibleTabKeyboardFocus_(t), "focus" == t.type && (n.pointerDownRecognized_ = !1)
                    }, n.blurHandler_ = function() {
                ...
                return o(e, t), c(e, [{
                    ...
                    value: function(t) {
                        ...
                        clearTimeout(this.timeoutId_), this.snackbarData_ = t, this.firstFocus_ = !0, this.adapter_.registerVisibilityChangeHandler(this.visibilitychangeHandler_), this.adapter_.registerCapturedBlurHandler(this.blurHandler_), ["touchstart", "mousedown", "focus"].forEach(function(t) {
                    ...
                    value: function() {
                        ...
                        if (!this.snackbarHasFocus_ || this.actionWasClicked_) {
                            ...
                            var i = function e() {
                                clearTimeout(t.timeoutId_), t.adapter_.deregisterTransitionEndHandler(e), t.adapter_.removeClass(n), t.adapter_.removeClass(r), t.setActionHidden_(!0), t.adapter_.setAriaHidden(), t.active_ = !1, t.snackbarHasFocus_ = !1, t.showNext_()
                            };
        ...
        var a = n(0),
            ...
            l = function(t) {
                function e() {
                    ...
                    r(this, e);
                    var n = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, u(e.defaultAdapter, t)));
                    return n.computedWidth_ = 0, n.computedLeft_ = 0, n.isActive_ = !1, n.preventDefaultOnClick_ = !1, n.clickHandler_ = function(t) {
                ...
                return o(e, t), c(e, null, [{
                    ...
                    key: "init",
                    value: function() {
                        this.adapter_.registerInteractionHandler("click", this.clickHandler_), this.adapter_.registerInteractionHandler("keydown", this.keydownHandler_)
                    }
                }, {
                    key: "destroy",
                    value: function() {
                        this.adapter_.deregisterInteractionHandler("click", this.clickHandler_), this.adapter_.deregisterInteractionHandler("keydown", this.keydownHandler_)
                    }
                }, {
                    ...
                    key: "setActive",
                    value: function(t) {
                        this.isActive_ = t, this.isActive_ ? this.adapter_.addClass(s.a.ACTIVE) : this.adapter_.removeClass(s.a.ACTIVE)
                    }
                }, {
                    ...
                    key: "measureSelf",
                    value: function() {
                        this.computedWidth_ = this.adapter_.getOffsetWidth(), this.computedLeft_ = this.adapter_.getOffsetLeft()
                    }
                }]), e
            }(a.a);
        e.a = l
        ...
        var a = n(0),
            ...
            d = function(t) {
                function e(t) {
                    r(this, e);
                    var n = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, c(e.defaultAdapter, t)));
                    return n.isIndicatorShown_ = !1, n.computedWidth_ = 0, n.computedLeft_ = 0, n.activeTabIndex_ = 0, n.layoutFrame_ = 0, n.resizeHandler_ = function() {
                        return n.layout()
                    }, n
                }
                return o(e, t), l(e, null, [{
                    ...
                    key: "init",
                    value: function() {
                        this.adapter_.addClass(u.a.UPGRADED), this.adapter_.bindOnMDCTabSelectedEvent(), this.adapter_.registerResizeHandler(this.resizeHandler_);
                    ...
                    key: "destroy",
                    value: function() {
                        this.adapter_.removeClass(u.a.UPGRADED), this.adapter_.unbindOnMDCTabSelectedEvent(), this.adapter_.deregisterResizeHandler(this.resizeHandler_)
                    }
                }, {
                    key: "layoutInternal_",
                    value: function() {
                        ...
                        }), this.computedWidth_ = this.adapter_.getOffsetWidth(), this.layoutIndicator_()
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        this.adapter_.setStyleForIndicator(Object(s.b)(window, "transform"), r), t && (this.adapter_.getOffsetWidthForIndicator(), this.adapter_.setStyleForIndicator("transition", ""), this.adapter_.setStyleForIndicator("visibility", "visible"), this.isIndicatorShown_ = !0)
                    }
                }, {
                    ...
                    value: function(t) {
                        for (var e = this.adapter_.getNumberOfTabs(), n = 0; n < e && !t(n); n++);
                    }
                }, {
                    key: "layout",
                    value: function() {
                    ...
                    value: function(t, e) {
                        ...
                        if (t !== this.activeTabIndex_) {
                            if (t < 0 || t >= this.adapter_.getNumberOfTabs()) throw new Error("Out of bounds index specified for tab: " + t);
                            var r = this.activeTabIndex_;
                            this.activeTabIndex_ = t, requestAnimationFrame(function() {
                                r >= 0 && n.adapter_.setTabActiveAtIndex(r, !1), n.adapter_.setTabActiveAtIndex(n.activeTabIndex_, !0), n.layoutIndicator_(), e && n.adapter_.notifyChange({
        ...
        var a = n(0),
            ...
            l = function(t) {
                function e(t) {
                    r(this, e);
                    var n = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, u(e.defaultAdapter, t)));
                    return n.pointerDownRecognized_ = !1, n.currentTranslateOffset_ = 0, n.focusedTarget_ = null, n.layoutFrame_ = 0, n.scrollFrameScrollLeft_ = 0, n.forwardIndicatorClickHandler_ = function(t) {
                ...
                return o(e, t), c(e, null, [{
                    ...
                    value: function() {
                        var t = this;
                        this.adapter_.registerBackIndicatorClickHandler(this.backIndicatorClickHandler_), this.adapter_.registerForwardIndicatorClickHandler(this.forwardIndicatorClickHandler_), this.adapter_.registerWindowResizeHandler(this.resizeHandler_), ["touchstart", "mousedown", "focus"].forEach(function(e) {
                    ...
                    value: function() {
                        var t = this;
                        this.adapter_.deregisterBackIndicatorClickHandler(this.backIndicatorClickHandler_), this.adapter_.deregisterForwardIndicatorClickHandler(this.forwardIndicatorClickHandler_), this.adapter_.deregisterWindowResizeHandler(this.resizeHandler_), ["touchstart", "mousedown", "focus"].forEach(function(e) {
                            t.adapter_.deregisterCapturedInteractionHandler(e, t.interactionHandler_)
                        })
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        for (var e = 0, n = 0, r = this.adapter_.getNumberOfTabs() - 1; r > 0; r--) {
                            ...
                            if (this.isRTL_() && (a = o > this.currentTranslateOffset_), !a && (e += this.adapter_.getComputedWidthForTabAtIndex(r)) > this.adapter_.getOffsetWidthForScrollFrame()) {
                                n = this.isRTL_() ? r + 1 : r;
                                break
                            }
                        }
                    ...
                    value: function() {
                        var t = this;
                        cancelAnimationFrame(this.layoutFrame_), this.scrollFrameScrollLeft_ = this.adapter_.getScrollLeftForScrollFrame(), this.layoutFrame_ = requestAnimationFrame(function() {
                            return t.layout_()
                        })
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        this.adapter_.getOffsetWidthForTabBar() > t || (this.currentTranslateOffset_ = 0), this.shiftFrame_(), this.updateIndicatorEnabledStates_()
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        this.currentTranslateOffset_ = this.normalizeForRTL_(n, r), requestAnimationFrame(function() {
                    ...
                    value: function() {
                        ...
                        this.adapter_.setTransformStyleForTabBar("translateX(" + t + "px)"), this.updateIndicatorEnabledStates_()
                    }
                }, {
                    key: "updateIndicatorEnabledStates_",
                    value: function() {
                        var t = s.a.INDICATOR_ENABLED;
                        0 === this.currentTranslateOffset_ ? this.adapter_.removeClassFromBackIndicator(t) : this.adapter_.addClassToBackIndicator(t), this.adapter_.getOffsetWidthForTabBar() - this.currentTranslateOffset_ > this.adapter_.getOffsetWidthForScrollFrame() ? this.adapter_.addClassToForwardIndicator(t) : this.adapter_.removeClassFromForwardIndicator(t)
                    }
                }]), e
            }(a.a);
        e.a = l
        ...
        n.d(e, "MDCTextFieldFoundation", function() {
            return l.a
        }), n.d(e, "MDCTextFieldBottomLine", function() {
            return d.a
        }), n.d(e, "MDCTextFieldBottomLineFoundation", function() {
            return d.b
        ...
        var _ = Object.assign || function(t) {
            ...
            v = function(t) {
                function e() {
                    ...
                    for (var n = arguments.length, o = Array(n), a = 0; a < n; a++) o[a] = arguments[a];
                    var s = i(this, (t = e.__proto__ || Object.getPrototypeOf(e)).call.apply(t, [this].concat(o)));
                    return s.input_, s.label_, s.ripple, s.bottomLine_, s.helperText_, s.icon_, s
                }
                return o(e, t), p(e, [{
                    key: "initialize",
                    value: function() {
                        ...
                        if (this.input_ = this.root_.querySelector(c.b.INPUT_SELECTOR), this.label_ = this.root_.querySelector(c.b.LABEL_SELECTOR), this.ripple = null, this.root_.classList.contains(c.a.BOX)) {
                            var r = Object(u.getMatchesProperty)(HTMLElement.prototype),
                                i = _(s.MDCRipple.createAdapter(this), {
                                    isSurfaceActive: function() {
                                        return t.input_[r](":active")
                                    },
                                    registerInteractionHandler: function(e, n) {
                            ...
                            this.ripple = e(this.root_, o)
                        }
                        if (!this.root_.classList.contains(c.a.TEXTAREA)) {
                            var a = this.root_.querySelector(c.b.BOTTOM_LINE_SELECTOR);
                            a && (this.bottomLine_ = n(a))
                        }
                        if (this.input_.hasAttribute(c.b.ARIA_CONTROLS)) {
                            var l = document.getElementById(this.input_.getAttribute(c.b.ARIA_CONTROLS));
                            l && (this.helperText_ = new f.a(l))
                        }
                        this.root_.classList.contains(c.a.TEXT_FIELD_ICON) || (this.icon_ = this.root_.querySelector(c.b.ICON_SELECTOR))
                    }
                }, {
                    key: "destroy",
                    value: function() {
                        this.ripple && this.ripple.destroy(), this.bottomLine_ && this.bottomLine_.destroy(), this.helperText_ && this.helperText_.destroy(), h(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "destroy", this).call(this)
                    }
                }, {
                    key: "initialSyncWithDom",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        return new l.a(_({
                            ...
                            notifyIconAction: function() {
                                return t.emit(l.a.strings.ICON_EVENT, {})
                            },
                            registerBottomLineEventHandler: function(e, n) {
                                t.bottomLine_ && t.bottomLine_.listen(e, n)
                            },
                            deregisterBottomLineEventHandler: function(e, n) {
                                t.bottomLine_ && t.bottomLine_.unlisten(e, n)
                            }
                    ...
                    value: function() {
                        var t = this;
                        return {
                            setIconAttr: function(e, n) {
                                t.icon_ && t.icon_.setAttribute(e, n)
                            }
                        }
                    }
                }, {
        ...
        var a = n(0),
            ...
            d = function(t) {
                function e() {
                    ...
                    r(this, e);
                    var o = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, c(e.defaultAdapter, t)));
                    return o.bottomLine_ = n.bottomLine, o.helperText_ = n.helperText, o.isFocused_ = !1, o.receivedUserInput_ = !1, o.useCustomValidityChecking_ = !1, o.inputFocusHandler_ = function() {
                        ...
                        return o.setBottomLineTransformOrigin(t)
                    }, o.textFieldInteractionHandler_ = function(t) {
                        return o.handleTextFieldInteraction(t)
                    }, o.bottomLineAnimationEndHandler_ = function() {
                        return o.handleBottomLineAnimationEnd()
                    }, o
                }
                return o(e, t), l(e, null, [{
                    key: "cssClasses",
                    ...
                    value: function() {
                        ...
                        }), this.adapter_.registerBottomLineEventHandler(s.a.strings.ANIMATION_END_EVENT, this.bottomLineAnimationEndHandler_)
                    }
                }, {
                    key: "destroy",
                    value: function() {
                        ...
                        }), this.adapter_.deregisterBottomLineEventHandler(s.a.strings.ANIMATION_END_EVENT, this.bottomLineAnimationEndHandler_)
                    }
                }, {
                    ...
                    value: function(t) {
                        if (!this.adapter_.getNativeInput().disabled) {
                            ...
                            o && a && this.adapter_.notifyIconAction()
                        }
                    }
                }, {
                    key: "activateFocus",
                    value: function() {
                        var t = e.cssClasses,
                            ...
                            i = t.LABEL_SHAKE;
                        this.adapter_.addClass(n), this.bottomLine_ && this.bottomLine_.activate(), this.adapter_.addClassToLabel(r), this.adapter_.removeClassFromLabel(i), this.helperText_ && this.helperText_.showToScreenReader(), this.isFocused_ = !0
                    }
                }, {
                    key: "setBottomLineTransformOrigin",
                    value: function(t) {
                        this.bottomLine_ && this.bottomLine_.setTransformOrigin(t)
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        this.isFocused_ = !1, this.adapter_.removeClass(n), this.adapter_.removeClassFromLabel(i), o.value || this.isBadInput_() || (this.adapter_.removeClassFromLabel(r), this.receivedUserInput_ = !1), this.useCustomValidityChecking_ || this.changeValidity_(o.checkValidity())
                    }
                }, {
                    key: "changeValidity_",
                    value: function(t) {
                        var n = e.cssClasses,
                            r = n.INVALID,
                            i = n.LABEL_SHAKE;
                        t ? this.adapter_.removeClass(r) : (this.adapter_.addClassToLabel(i), this.adapter_.addClass(r)), this.helperText_ && this.helperText_.setValidity(t)
                    }
                }, {
                    key: "isBadInput_",
                    value: function() {
                        var t = this.getNativeInput_();
                        return t.validity ? t.validity.badInput : t.badInput
                    }
                }, {
                    key: "isDisabled",
                    value: function() {
                    ...
                    value: function(t) {
                        var n = e.cssClasses,
                            r = n.DISABLED,
                            i = n.INVALID;
                        this.getNativeInput_().disabled = t, t ? (this.adapter_.addClass(r), this.adapter_.removeClass(i), this.adapter_.setIconAttr("tabindex", "-1")) : (this.adapter_.removeClass(r), this.adapter_.setIconAttr("tabindex", "0"))
                    }
                }, {
                    ...
                    key: "setValid",
                    value: function(t) {
                        this.useCustomValidityChecking_ = !0, this.changeValidity_(t)
                    }
                }]), e
            }(a.a);
        e.a = d
                ...
                return o(e, t), c(e, [{
                    ...
                    value: function() {
                        ...
                        return new s.a(u({
                            ...
                            notifyAnimationEnd: function() {
                                t.emit(s.a.strings.ANIMATION_END_EVENT, {})
                            }
                        }))
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        return new s.a({
                            ...
                            registerScrollHandler: function(t) {
                                return window.addEventListener("scroll", t, u.applyPassive())
                            },
                            deregisterScrollHandler: function(t) {
                                return window.removeEventListener("scroll", t, u.applyPassive())
                            },
                            registerResizeHandler: function(t) {
                                return window.addEventListener("resize", t)
                            },
