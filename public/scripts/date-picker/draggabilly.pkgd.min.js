...
function(t, i) {
    ...
    function r(i) {
        if (o(), "string" == typeof i && (i = document.querySelector(i)), i && "object" == typeof i && i.nodeType) {
            ...
            for (var u = a.isBorderBox = "border-box" == r.boxSizing, p = 0; d > p; p++) {
                var c = h[p],
                    f = r[c],
                    g = parseFloat(f);
                a[c] = isNaN(g) ? 0 : g
...
function(t, i) {
    ...
    function s(t, i) {
        this.element = "string" == typeof t ? h.querySelector(t) : t, f && (this.$element = f(this.element)), this.options = o({}, this.constructor.defaults), this.option(i), this._create()
    }
    ...
    var h = t.document,
        d = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame,
        u = 0;
    d || (d = function(t) {
    ...
    var p = h.documentElement,
        c = "string" == typeof p.style.transform ? "transform" : "WebkitTransform",
        f = t.jQuery,
        g = s.prototype = Object.create(e.prototype);
    return s.defaults = {}, g.option = function(t) {
        o(this.options, t)
    }, g._create = function() {
    ...
    }, s.prototype._getPositionCoord = function(t, e) {
        if (-1 != t.indexOf("%")) {
            var n = i(this.element.parentNode);
            return parseFloat(t) / 100 * n[e]
        }
        ...
        e && e.blur && e != h.body && e.blur(), this._bindPostStartEvents(t), this.element.classList.add("is-pointer-down"), this.dispatchEvent("pointerDown", t, [i])
        ...
        if (t) {
            var e = r(t) ? t : "string" == typeof t ? h.querySelector(t) : this.element.parentNode,
                n = i(this.element),
                o = i(e),
                ...
                p = this.relativeStartPosition = {
                    x: s.left - (a.left + o.borderLeftWidth),
                    y: s.top - (a.top + o.borderTopWidth)
                };
            this.containSize = {
                width: o.width - d - p.x - n.width,
                height: o.height - u - p.y - n.height
            }
        }
        ...
        if (this.isEnabled) {
            var n = e.x,
                ...
                s = r && r[0],
                h = r && r[1];
            n = a(n, s), o = a(o, h), n = this.containDrag("x", n, s), o = this.containDrag("y", o, h), n = "y" == this.options.axis ? 0 : n, o = "x" == this.options.axis ? 0 : o, this.position.x = this.startPosition.x + n, this.position.y = this.startPosition.y + o, this.dragPoint.x = n, this.dragPoint.y = o, this.dispatchEvent("dragMove", t, [i, e])
        }
        ...
        this.isEnabled && (c && (this.element.style[c] = "", this.setLeftTop()), this.element.classList.remove("is-dragging"), this.dispatchEvent("dragEnd", t, [i]))
    }, g.animate = function() {
        if (this.isDragging) {
            this.positionDrag();
            var t = this;
        ...
        this.element.style[c] = "translate3d( " + this.dragPoint.x + "px, " + this.dragPoint.y + "px, 0)"
        ...
        this.disable(), this.element.style[c] = "", this.element.style.left = "", this.element.style.top = "", this.element.style.position = "", this.unbindHandles(), this.$element && this.$element.removeData("draggabilly")
